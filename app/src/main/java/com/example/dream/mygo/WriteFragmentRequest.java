...
public class WriteFragmentRequest extends StringRequest {
    ...
    public WriteFragmentRequest(String userID, String courseTitle, String courseStroy, String targetGender, String targetAge, String courseWorry, int timeToDelete, Response.Listener<String> listener) {
